...
import type { GetPlayerResponse, Player, PlayerAliases, PlayerClan, PlayerGadgets, PlayerRanked, PlayerRanked1v1, PlayerRanked2v2, PlayerRankedRotating } from './schema'


export const getPlayer = (playerId: number) => Effect.gen(function* () {
    ...
    const response: typeof GetPlayerResponse.Type = {
        data: playerData,
        meta: {
            updatedAt,
        },
