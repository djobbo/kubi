  ...
  return (
    <>
      ...
      >
        ...
        >
          <span className="text-lg font-semibold text-muted-foreground mr-2">{rank} -</span>
          {content}
          <RankedTierIcon
            tier={tier}
            alt={tier}
      ...
      >
        <p className="w-16 h-full flex items-center justify-center text-xs">{rank}</p>
        ...
        <p className="w-16 h-full flex items-center justify-center text-xs">{region}</p>
        {content}
        ...
        <p className="w-20 text-center">{calculateWinrate(wins, games).toFixed(2)}%</p>
        <div className="w-40 flex items-center justify-start">
          <p>
            <span className="text-xl font-bold">{rating}</span>{' '}
            <span className="text-muted-foreground text-sm">/ {peak_rating} peak</span>
          </p>
        </div>
      </div>
    </>
