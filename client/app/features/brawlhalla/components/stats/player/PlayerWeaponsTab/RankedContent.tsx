...
export const PlayerWeaponRankedContent = memo(function PlayerWeaponRankedContent({
  weapon,
    ...
    (acc, legend) => {
      ...
      return {
        ...
        highestPeakRatedLegend:
          (acc.highestPeakRatedLegend?.ranked?.peak_rating ?? 0) < legend.ranked.peak_rating
            ? legend
  ...
  const peakRating = Math.floor(ranked.totalPeakRating / weapon.legends.length);
