    ...
    <>
      <div className="flex flex-col items-center justify-center lg:gap-16 lg:flex-row">
        ...
        >
          ...
          >
            <Trans>
              Improve your Brawlhalla Game, and find your place among the Elite with our in-depth
              stats tracking and live leaderboards.
            </Trans>
          </p>
          <div className="mt-8 flex items-center gap-3 sm:gap-6 flex-col sm:flex-row">
            <SearchButton />
            {/* <CommandMenu title={t`Search player...`} /> */}
            <span className="text-muted-foreground text-sm sm:text-base">or</span>
            <div className="flex items-center gap-2">
              ...
              <Button asChild variant="outline" className="whitespace-nowrap font-semibold">
        ...
        {bookmarks.length > 0 ? (
          ...
          <p className="flex flex-col items-center gap-4 py-4">
            {isLoggedIn ? (
              <>
                <Trans>
                  You don&apos;t have any favorites yet, you can a player or a clan as favorite when
              ...
              <>
                <span className="text-muted-foreground">
                  <Trans>Here you{"'"}ll be able to see your favorite players and clans</Trans>
                </span>
