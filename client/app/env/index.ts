...
export const env = {
  IS_DEV,
  IS_PROD,
  SERVICE_API_KEY: envField('Service API Key', metaEnv.SERVICE_API_KEY, z.string().min(1)),
  DATABASE_URL: envField('Database URL', metaEnv.DATABASE_URL, z.string().min(1)),
  DISCORD_CLIENT_ID: envField('Discord Client ID', metaEnv.DISCORD_CLIENT_ID, z.string().min(1)),
  ...
  BRAWLHALLA_API_KEY: envField('Brawlhalla API Key', metaEnv.BRAWLHALLA_API_KEY, z.string().min(1)),
