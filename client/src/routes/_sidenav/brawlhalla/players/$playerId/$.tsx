...
function RouteComponent() {
	const { playerId } = PlayerRoute.useLoaderData()
										...
										<div className="flex justify-between">
											<span>
												...
												<span className="text-text-muted font-normal text-sm">
													{((ranked1v1.wins / ranked1v1.games) * 100).toFixed(
														2,
													)}
													%)
												</span>
											...
											<span>
												...
												<span className="text-text-muted font-normal text-sm">
													{(
														((ranked1v1.games - ranked1v1.wins) /
															ranked1v1.games) *
														100
													).toFixed(2)}
													%)
